...
//		* int sayac=0;           =======>> count bu sekılde de yapılabılır yada ====> count+=St.executeUpdate(each); boyle
...
// ----------------------------------------------------
	 	...
	 	for(String each:sorgular1) {
	 		st.addBatch(each); 		// for dongusuyle array den bır bır gelen verileri bir araya toplar
	 	}
